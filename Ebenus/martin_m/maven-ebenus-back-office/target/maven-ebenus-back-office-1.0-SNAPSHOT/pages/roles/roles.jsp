        ...
        <!-- /.row -->
         <div class="row">
            <div class="well well-lg clearfix">
                <a href="AddRoleServlet" role="button">Ajouter Role</a>
            </div>
         </div>
          <!-- /.row -->
          <div class="row">
            <div class="panel panel-default">
              ...
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-users"></i> Liste des Roles</h3>
              </div>
              <div class="panel-body">
                <div class="well well-sm">
                  <form action="#" method="get">
                  <div class="input-group">
                      <input class="form-control" id="system-search" name="q" placeholder="Rechercher un role" required>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody id="test">
                        ...
                        <tr>
                          <td><c:out value="${role.getIdRole()}"/></td>
                          <td><c:out value="${role.getIdentifiant()}"/></td>
                          <td><c:out value="${role.getDescription()}"/></td>
                          <td><a href="AddRoleServlet?id=<c:out value="${role.getIdRole()}"/>"><i class="fa fa-edit"></i></a></td>
                          <td>
                              <c:if test="${loggedUser.getIdUtilisateur() != utilisateur.getIdUtilisateur()}"> 
                                <a <c:out value="id='${role.getIdRole()}'"/> href="#" class="no-style-btn"><i class="fa fa-trash-o trash-role"></i></a>
                              </c:if>
                          </td>
                        </tr>
                      </c:forEach>                        

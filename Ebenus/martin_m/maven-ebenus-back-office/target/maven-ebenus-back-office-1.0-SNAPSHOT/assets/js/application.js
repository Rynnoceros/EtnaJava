...
$('.trash-user').each(function(index, el) {
  var that = $(this);
  $(this).click(function(event) {
    event.preventDefault();
    $.ajax({
        url: 'CrudUserServlet?' + $.param({"id": $(this).closest('a').attr('id')}),
        method: 'DELETE',
...
$('.trash-product').each(function(index, el) {
  var that = $(this);
  $(this).click(function(event) {
    event.preventDefault();
    $.ajax({
        url: 'CrudProductServlet?' + $.param({"id": $(this).closest('a').attr('id')}),
        method: 'DELETE',
        success: function(response) {
            that.closest('tr').remove();
            that.closest('.product').remove();
...
$('.trash-role').each(function(index, el) {
  var that = $(this);
  $(this).click(function(event) {
    event.preventDefault();
    $.ajax({
        url: 'CrudRoleServlet?' + $.param({"id": $(this).closest('a').attr('id')}),
        method: 'DELETE',
        success: function(response) {
            that.closest('tr').remove();
            that.closest('.product').remove();
...
$('.trash-order').each(function(index, el) {
  var that = $(this);
  $(this).click(function(event) {
    event.preventDefault();
    $.ajax({
        url: 'ListOrderServlet?' + $.param({"id": $(this).closest('a').attr('id')}),
        method: 'DELETE',
        success: function(response) {
            that.closest('tr').remove();
            that.closest('.product').remove();

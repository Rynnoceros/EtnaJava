            ...
            <section>
                    <div class="content">
                        <div class="User quest">
                            <h1>                                
                                <c:if test="${roleToUpdate.getIdRole() == null}">
                                    Créer un role
                                </c:if>
                                <c:if test="${roleToUpdate.getIdRole() != null}">
                            ...
                            <form  method="post" id="customer-info-form" class="no-gutters">
                                <div class="account-container row">
                                    <fieldset class=" common-form-controls col-md-6">
                                        <div >
                                            <p>Informations Role</p>
                                            <div class="input-wrapper">
                                                <label for="identifiant">Identifiant du role</label>
                                                <input  autocomplete="off"  name="identifiant" id="identifiant" type="text" value="<c:out value="${roleToUpdate.getIdentifiant()}"/>">
                                            </div>
                                            <div class="input-wrapper">
                                                <label for="description">Description</label>
                                                <input  autocomplete="off"  name="description" id="description" type="text" value="<c:out value="${roleToUpdate.getDescription()}"/>">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="row">
                                    <div class="actions col-md-4">
                                        <button type="submit">
                                            <c:if test="${roleToUpdate.getIdRole() == null}">Ajouter</c:if>
                                            <c:if test="${roleToUpdate.getIdRole() != null}">Modifier</c:if>
                                        </button>
                                    </div>
                                </div>
                            </form>

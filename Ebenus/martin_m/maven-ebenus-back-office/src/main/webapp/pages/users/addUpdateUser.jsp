                                                ...
                                                <div class="sel">
                                                    <select  class="required" name="select_city" id="select_city"> 
                                                        ...
                                                        <c:forEach items="${roles}" var="role">
                                                            <option value="<c:out value="${role.getIdentifiant()}"/>" <c:out value="${utilisateurToUpdate.getIdUtilisateur() != null && utilisateurToUpdate.getRole().getIdentifiant().equals(role.getIdentifiant()) ? 'selected' : ''}"/>><c:out value="${role.getIdentifiant()}"/></option>  
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>

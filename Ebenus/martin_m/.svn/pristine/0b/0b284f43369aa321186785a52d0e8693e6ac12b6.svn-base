...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="images/detail-product/refrigerateurs/refrigerateur-2_1.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>BEKO Réfrigérateur Double porte RDNT360I20BS - 321 L - Froid No Frost</h1>
    </div>

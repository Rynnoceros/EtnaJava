...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://image.darty.com/audio_mp3_mp4/enceinte_ipod_ipad_iphone_mp3-chaine_hi-fi/chaine_micro/denon_n9_white_s1410174042310A_160425414.png" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Mini-chaine Hi-Fi Bluetooth Denon CEOL Piccolo N4 Blanc</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               <li>Puissance : Puissance 2 x 40 W</li>
               <li>Couleur enceintes : Blanc</li>
           </ul>
        </div>
    </div>

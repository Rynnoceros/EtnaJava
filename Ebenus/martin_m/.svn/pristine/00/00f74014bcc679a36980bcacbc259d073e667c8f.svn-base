...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="images/detail-product/refrigerateurs/refrigerateur-1_4.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>SELECLINE Réfrigérateur 2 portes 180470 , 253 L, Froid Statique</h1>
    </div>

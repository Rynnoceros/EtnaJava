...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="images/detail-product/refrigerateurs/refrigerateur-2_2.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>CANDY  Réfrigérateur 2 portes CCDS 5142 WH, 204 L, Froid Statique</h1>
    </div>

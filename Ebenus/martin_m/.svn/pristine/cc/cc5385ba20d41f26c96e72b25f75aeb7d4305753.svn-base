...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://www.rueducommerce.fr/medias/bd5c4d9151443f239fc822ff5243b5ca/p_580x580/sgh-galaxy-a5-2017-rose.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Smartphone Samsung Galaxy A5 2017 (rose)</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Couleur : Rose</li>
                <li>OS (type) : Android</li>
                <li>Robuste : Certifié IP68</li>
                <li>Batterie : 3000 mAh</li>
                <li>Taille écran : 5,2"</li>
                <li>Processeur : Samsung Exynos 7880 Octo-Core 1,9 GHz</li>
            </ul>
        </div>
    </div>

...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://media.ldlc.com/ld/products/00/04/12/47/LD0004124748_2_0004428236.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>PC portable gamer MSI GS73 7RE-006FR - i7 - 8 Go - SSD - GTX 1050 Ti</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Écran : 17,3"</li>
                <li>Modèle : Processeur Intel® Core™ i7-7700HQ (2,80 GHz)</li>
                <li>Capacité mémoire : 8 Go</li>
                <li>Modèle de carte graphique gamer : NVIDIA GeForce GTX 1050 Ti</li>
                <li>Espace disque total : 1128 Go</li>
                <li>Version système d'exploitation : Windows 10 Famille</li>
            </ul>
        </div>
    </div>

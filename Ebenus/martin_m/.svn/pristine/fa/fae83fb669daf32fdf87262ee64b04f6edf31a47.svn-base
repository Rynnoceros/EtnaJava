...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="images/detail-product/refrigerateurs/refrigerateur-2_3.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>INDESIT Réfrigérateur Double porte TIAA10SI.1 - 252 L - Froid Statique</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <p>Type de froid du congélateur : Ventilé sans givre</p>
            <p>Capacité du congélateur nette : 192 L</p>
            <p>Capacité du réfrigérateur nette : 370 L</p>
            <p>Capacité totale du réfrigérateur : 338 L</p>
        </div>
    </div>

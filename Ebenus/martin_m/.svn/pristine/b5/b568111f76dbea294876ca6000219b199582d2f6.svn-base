                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody id="test">
                        ...
                        <tr>
                          <td><c:out value="${utilisateur.getPrenom()} ${utilisateur.getNom()}"/></td>
                          <td><c:out value="${utilisateur.getActif()}"/></td>
                          ...
                          <td>
                            <c:forEach items="${allAddresses}" var="address">
                                <c:if test="${address.getUtilisateur().getIdUtilisateur().equals(utilisateur.getIdUtilisateur())}">
                                    <c:out value="${address.getRue()}, ${address.getCodePostal()} ${address.getVille()}"/>
                                </c:if>
                            </c:forEach>
                          </td>
                          <td><a href="AddUserServlet?id=<c:out value="${utilisateur.getIdUtilisateur()}"/>"><i class="fa fa-edit"></i></a></td>
                          <td>
                              <c:if test="${loggedUser.getIdUtilisateur() != utilisateur.getIdUtilisateur()}"> 
                                <a <c:out value="id='${utilisateur.getIdUtilisateur()}'"/> href="#" class="no-style-btn"><i class="fa fa-trash-o trash-user"></i></a>
                              </c:if>
                          </td>
                        </tr>
                      </c:forEach>                        

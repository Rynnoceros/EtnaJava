...
public class ArticleCommande {
    ...
    public ArticleCommande(Integer idArticleCommande, Double totalArticleCommande, String reference, Integer quantite,
    ...
    public ArticleCommande(Double totalArticleCommande, String reference, Integer quantite, String statut, 

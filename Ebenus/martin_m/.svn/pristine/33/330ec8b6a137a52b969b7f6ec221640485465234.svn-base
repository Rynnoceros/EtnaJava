...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://www.materielmaroc.com/wp-content/uploads/2017/11/asus-cerberus-artic-2500-dpi-gaming.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Souris gamer Asus Cerberus Mouse - Noir</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               <li>Utilisation recommandée : Jeu</li>
               <li>Type de capteur : Capteur optique</li>
               <li>Type de connexion : Filaire</li>
               <li>Forme : Ambidextre</li>
               <li>Résolution maximale : 2500 dpi</li>
               <li>Boutons : 6 boutons</li>
           </ul>
        </div>
    </div>

...
<div class=" common-form-controls">
		...
		<form id="customer-info-form" method="post" action="#" class="row validate no-gutters">
			...
			<h2>Adresse de facturation</h2>
				...
				<label for="street">Rue</label>
				<input value="${rueL}" name="streetL" id="streetL" type="text">
				<label for="postalcode">Code Postale</label>
				<input value="${codePostalL}" name="postalcodeL" id="postalcodeL" type="text">
				<label for="city">Ville</label>
				<input value="${villeL}" name="cityL" id="cityL" type="text">
				<label for="country">Pays</label>
				<input value="${paysL}" name="countryL" id="countryL" type="text">

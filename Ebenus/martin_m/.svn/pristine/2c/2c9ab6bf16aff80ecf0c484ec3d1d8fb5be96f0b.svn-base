...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://i2.cdscdn.com/pdt2/3/7/o/1/700x700/samgalaxyj37o/rw/samsung-galaxy-j3-2017-or.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Smartphone Samsung Galaxy J3 2017 (noir)</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               ...
               <li>Batterie : 2400 mAh</li>
               <li>Taille écran : 5"</li>
               <li>Processeur : Samsung Exynos 7550 Quad-core 1,4 GHz</li>
               <li>Mémoire stockage : 16 Go</li>
           </ul>
        </div>
    </div>

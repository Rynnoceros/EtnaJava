    ...
    private Utilisateur createUtilisateur(ResultSet set) {
        ...
        if(set != null) {
        	try {
	        	...
	        	instance.setDateCreation(set.getTimestamp("dateCreation"));
	        	instance.setDateModification(set.getTimestamp("dateModification"));
	        	instance.setDateNaissance(set.getTimestamp("dateNaissance"));

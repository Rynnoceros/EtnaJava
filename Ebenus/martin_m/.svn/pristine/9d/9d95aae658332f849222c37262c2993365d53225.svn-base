...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://asset.conrad.com/media10/isa/160267/c1/-/fr/1561298_AB_00_FB/fujifilm-instax-mini-9-appareil-photo-a-developpement-instantane-fumee-blanc.jpg?x=520&y=520" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Appareil photo instantané Fujifilm Instax MINI 9 Blanc</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Type : Appareil photo instantané</li>
            </ul>
        </div>
    </div>

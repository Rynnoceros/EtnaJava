          ...
          <div class="row">
            <div class="panel panel-default">
              ...
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-users"></i> Liste des Commandes</h3>
              </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <ul class="User f-left">
                            <li>
                                <a href="ExportServlet?export=xml" role="button">Export XML</a>
                            </li>
                            <li>
                                <a href="ExportServlet?export=json" role="button">Export Json</a>
                            </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody id="test">
                        ...
                        <tr>
                          <td><c:out value="${order.getIdCommande()}"/></td>
                          <td><c:out value="${order.getDateCommande()}"/></td>
                          <td><c:out value="${order.getDateModification()}"/></td>
                          <td><c:out value="${order.getUtilisateur().getIdentifiant()}"/></td>
                          <td><c:out value="${order.getStatut()}"/></td>
                          <td><c:out value="${order.getTotalCommande()} €"/></td>
                          <td><a href="ViewOrderDetailServlet?id=<c:out value="${order.getIdCommande()}"/>">Detail commande</a></td>
                          <td>
                              <c:if test="${loggedUser.getIdUtilisateur() != utilisateur.getIdUtilisateur()}"> 
                                <a <c:out value="id='${order.getIdCommande()}'"/> href="#" class="no-style-btn"><i class="fa fa-trash-o trash-order"></i></a>
                              </c:if>
                          </td>
                        </tr>
                      </c:forEach>                        

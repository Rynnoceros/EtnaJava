...
public class Adresse {
    ...
    public Adresse(Utilisateur utilisateur, String rue, String codePostal, String ville, String pays, String statut, 
                    String typeAdresse, Boolean principale) {
        this(null, utilisateur, rue, codePostal, ville, pays, statut, typeAdresse, principale, 1);
    }
    
    public Adresse(Utilisateur utilisateur, String rue, String codePostal, String ville, String pays) {
        this(utilisateur, rue, codePostal, ville, pays, StatutAdresse.Permanent.toString(), TypeAdresse.Livraison.toString(), false);
    }
    ...
    @Override
    public int hashCode() {
        return this.idAdresse.hashCode() + this.utilisateur.hashCode() +
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.idAdresse == null && add.getIdAdresse() != null) ||
            (this.idAdresse != null && !this.idAdresse.equals(add.getIdAdresse()))) {
            return false;
        }
        return true;
    }

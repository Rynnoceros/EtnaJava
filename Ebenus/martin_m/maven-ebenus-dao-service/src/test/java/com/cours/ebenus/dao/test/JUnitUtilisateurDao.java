...
public class JUnitUtilisateurDao {
    ...
    private static final int NB_UTILISATEURS_FIND_BY_PRENOM = 1;

    private static final String UTILISATEUR_FIND_BY_NOM = "Petit";
    private static final int NB_UTILISATEURS_FIND_BY_NOM = 1;
    ...
    public void testCreateUpdateDeleteUtilisateur() {
        ...
        try {
            ...
            Assert.assertEquals(Constants.EXCEPTION_CODE_ELEMENT_ALREADY_EXIST, e.getCode());
        }

        ...
        <div class="row actions">
            ...
            <div class="col-md-5 registered-users">
                <div class="buttons-set_">
                    ...
                    <!--</form>--> 
                    <!--<a title="Create an Account" href="IndexServlet" role="button">Connexion</a>-->
                </div>
            </div>
            <div class="offset-md-2"></div>
             <div class="col-md-5 new-users">
                <div class="buttons-set">
                     <!-- <form action="creer-compte-client.html" method="get">
                        <button type="submit" title="Create an Account" class="button" >Créer le compte</button>
                    </form> -->
                    <a title="Create an Account" href="creer-compte-client.html" role="button">Créer le compte</a>
                </div>
            </div>
        </div>
       </form>

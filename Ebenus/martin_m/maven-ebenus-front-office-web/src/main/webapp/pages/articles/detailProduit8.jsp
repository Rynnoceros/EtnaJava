...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://dyw7ncnq1en5l.cloudfront.net/optim/produits/151/42217/msi-gt75-vr-7rf-titan-pro_a40abd709a72b84f__450_400.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>PC portable gamer MSI GT75VR 7RE-064FR - i7 - 16 Go - SSD - GTX 1070</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Écran : 17,3"</li>
                <li>Modèle : Processeur Intel® Core™ i7-7820HK (2,90 GHz)</li>
                <li>Capacité mémoire : 16 Go</li>
                <li>Modèle de carte graphique gamer : NVIDIA GeForce GTX 1070</li>
                <li>Espace disque total : 1256 Go</li>
                <li>Version système d'exploitation : Windows 10 Home</li>
            </ul>
        </div>
    </div>

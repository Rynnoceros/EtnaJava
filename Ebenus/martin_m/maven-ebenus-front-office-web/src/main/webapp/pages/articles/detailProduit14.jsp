...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://media.materiel.net/r550/oproducts/AR201809110048_g1_0005161481.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>PC Gamer Materiel.net Level One XI par Canard PC [ Win10 - PC Gamer ]</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Utilisation : PC de jeu</li>
                <li>Score global : 108 pts Matbench</li>
                <li>Modèle du processeur : Processeur AMD Ryzen 3 1200</li>
                <li>Puce graphique : AMD Radeon RX 560</li>
                <li>Taille SSD : SSD 120 Go</li>

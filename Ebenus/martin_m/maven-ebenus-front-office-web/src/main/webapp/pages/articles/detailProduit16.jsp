...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://www.rueducommerce.fr/medias/6703e98af1e33b739c8a839b49c7d05a/p_580x580/9887806849054.png" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>The G-Lab KORP#100</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               <li>Utilisation recommandée : Jeux</li>
               <li>Type : Stéréo</li>
               <li>Type d'écouteurs : Circum-aural (englobe les oreilles)</li>
               <li>Transducteur : Néodyme de 40 mm</li>
               <li>Connexion : 1x 3,5 mm ou 2x 3,5 mm</li>
               <li>Liste de compatibilité : Compatible PC, PS4, Xbox One (adaptateur nécessaire)</li>
           </ul>
        </div>
    </div>

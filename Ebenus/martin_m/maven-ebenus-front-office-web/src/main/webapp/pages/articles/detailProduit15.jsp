...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://images-na.ssl-images-amazon.com/images/I/41%2BenJA6eZL._SX355_.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Souris gamer The G-Lab KULT#100</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               ...
               <li>Forme : Pour droitier</li>
               <li>Résolution maximale : 3200 dpi</li>
               <li>Boutons : 7 boutons</li>
           </ul>
        </div>
    </div>

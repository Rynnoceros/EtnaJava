...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://www.plot-it.co.uk/images/3dconnexion_cadmouse_icreatia-540x300_large.png" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Souris PC 3DConnexion SpaceNavigator</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Utilisation recommandée : Graphisme</li>
                <li>Type de capteur : Capteur optique</li>
                <li>Type de connexion : Filaire</li>
                <li>Forme : Pour graphiste</li>
                <li>Boutons : 2 boutons</li>
            </ul>
        </div>
    </div>

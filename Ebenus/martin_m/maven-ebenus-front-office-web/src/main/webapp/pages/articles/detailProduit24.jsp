...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://i2.cdscdn.com/pdt2/3/6/0/1/400x400/lgcm8360/rw/lg-cm8360-mini-chaine-hi-fi.jpg" alt="" /> 
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Mini-chaine Hi-Fi USB Philips BTB2370 Bluetooth Tuner FM Numérique et DAB</h1>
    </div>

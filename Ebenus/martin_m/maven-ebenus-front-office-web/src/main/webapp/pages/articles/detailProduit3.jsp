...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://boltmobile.ca/wp-content/uploads/2016/05/caseco-mfi-approved-lightning-cable-3-meter-white.png" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Apple Câble Lightning / USB</h1>
    </div>

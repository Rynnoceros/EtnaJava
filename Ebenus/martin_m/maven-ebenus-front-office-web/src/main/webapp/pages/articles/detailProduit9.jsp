...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Appareil photo Compact Canon Ixus 185 Noir</h1>
    </div>
    <div class="short-description">
        <div class="std">
            <ul>
                <li>Zoom optique : 8x</li>
                <li>Type : Appareil photo compact</li>
                <li>Type : CCD</li>
                <li>Résolution : 20 Mpixels</li>
                <li>Taille d'écran : Ecran 2,7" (6,8 cm)</li>
            </ul>
        </div>
    </div>

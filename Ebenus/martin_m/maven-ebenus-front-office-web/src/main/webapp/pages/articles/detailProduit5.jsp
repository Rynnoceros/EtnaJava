...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://media.ldlc.com/ld/products/00/04/52/55/LD0004525511_2.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Ordinateur portable Asus Zenbook Flip 58256-B - i5 - 8 Go - 256 Go SSD </h1>
    </div>

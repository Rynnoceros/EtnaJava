...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://i2.cdscdn.com/pdt2/7/8/5/1/700x700/bel0745883706785/rw/belkin-mini-chargeur-secteur-2-1a-avec-cabe-usb-a.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>Chargeur secteur Belkin Chargeur secteur USB 2,1A</h1>
    </div>

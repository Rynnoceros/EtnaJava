...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="images/detail-product/refrigerateurs/refrigerateur-1_3.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>SAMSUNG Réfrigérateur 2 portes RT29K5030S9, 300 L, Froid Ventilé</h1>
    </div>

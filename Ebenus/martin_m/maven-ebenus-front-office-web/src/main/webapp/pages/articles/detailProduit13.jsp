...
<div class="product-img-box col-md-7 ">
    <ul>
        <li>
        <img class="detail-img" src="https://media.materiel.net/r550/oproducts/AR201703160005_g1.jpg" alt="" />
    </li>
...
<div class="product-shop col-md-5">
    <div class="product-name">
        <h1>PC Gamer MSI Vortex G25 8RD-028FR - i5 - 8 Go - GTX 1060 - SSD</h1>
    </div>
    <div class="short-description">
        <div class="std">
           <ul>
               <li>Utilisation : PC de jeu</li>
               <li>Modèle du processeur : Processeur Intel Core i5 8400</li>
               <li>Puce graphique : NVIDIA GeForce GTX 1060</li>
               <li>Taille SSD : SSD 128 Go</li>
               <li>Mémoire intégrée : 8 Go DDR4</li>
               <li>Système d'exploitation : Microsoft Windows 10</li>
           </ul>
        </div>
    </div>
        ...
        <div>
            <div class="price-box">
                <span class="regular-price" id="product-price-101">
                    <span class="price">1 349,90€</span>
                </span>
            </div>

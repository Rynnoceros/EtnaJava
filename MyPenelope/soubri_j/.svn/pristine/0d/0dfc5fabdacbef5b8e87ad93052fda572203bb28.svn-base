...
public class FXMLMessageManagementController implements Initializable {
    ...
    private final MessageSQLDao messageDao = new MessageSQLDao(Message.class, Constants.TABLE_MESSAGES);
    private final MessageDestinataireSQLDao messageDestinataireDao = new MessageDestinataireSQLDao(MessageDestinataire.class, Constants.TABLE_MESSAGES_DESTINATAIRES);

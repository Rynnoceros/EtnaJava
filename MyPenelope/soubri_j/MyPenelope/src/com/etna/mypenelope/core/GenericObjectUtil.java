...
/**
 * Generic object util to use reflexion
        ...
        try {
            ...
            if (field != null) {
                ...
                if (fieldClass == Boolean.class) {
                    toReturn = (((Boolean)field.get(element)).equals((Boolean)value));
                } else if (fieldClass == Byte.class) {
                    toReturn = (((Byte)field.get(element)).equals((Byte)value));
                } else if (fieldClass == Character.class) {
                    toReturn = (((Character)field.get(element)).equals((Character)value));
                } else if (fieldClass == Short.class) {
                    toReturn = (((Short)field.get(element)).equals((Short)value));
                } else if (fieldClass == Integer.class) {
                    toReturn = (((Integer)field.get(element)).equals((Integer)value));
                } else if (fieldClass == Long.class) {
                    toReturn = (((Long)field.get(element)).equals((Long)value));
                } else if (fieldClass == Float.class) {
                    toReturn = (((Float)field.get(element)).equals((Float)value));
                } else if (fieldClass == Double.class) {
                    toReturn = (((Double)field.get(element)).equals((Double)value));
